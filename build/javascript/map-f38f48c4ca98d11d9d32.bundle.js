...
var mapbox_gl_js_mock = __webpack_require__(523);
...
var idunn_poi = __webpack_require__(59);
...
var ActionButtons = __webpack_require__(287);
...
var GeolocationModal = __webpack_require__(289);
...
var server_browser = __webpack_require__(283);
...
var layouts = __webpack_require__(288);
...
var mapbox_style_configure = __webpack_require__(534);
...
var route_utils = __webpack_require__(40);

// EXTERNAL MODULE: ./src/panel/direction/VehicleIcon.jsx
var VehicleIcon = __webpack_require__(98);
...
var es = __webpack_require__(536);

// EXTERNAL MODULE: ./src/libs/geojson.js
var geojson = __webpack_require__(230);

// EXTERNAL MODULE: ./src/adapters/poi/latlon_poi.js
var latlon_poi = __webpack_require__(153);
...
var adapters_error = __webpack_require__(28);

// EXTERNAL MODULE: ./node_modules/alt-route-labeller/index.js + 6 modules
var alt_route_labeller = __webpack_require__(538);
...
var icon_manager = __webpack_require__(128);
...
var scene_category_SceneCategory = /*#__PURE__*/scene_category_createClass(function SceneCategory(map) {
  ...
  scene_category_defineProperty(this, "selectPoi", _ref => {
    ...
    window.app.navigateTo("/place/".concat(Object(libs_pois["j" /* toUrl */])(poi)), {
      poi,
      poiFilters,
      pois,
      centerMap: true
...
var getPoiView = poi => ({
  ...
  zoom: Object(libs_pois["c" /* getBestZoom */])(poi),
...
Scene.prototype.fitMap = function (item, forceAnimate) {
  ...
  if (item instanceof mapbox_gl_js_mock["LngLatBounds"] || Array.isArray(item)) {
    ...
    if (item.bbox) {
      ...
      var flyOptions = {
        center: item.latLon,
        zoom: Object(libs_pois["c" /* getBestZoom */])(item),
        screenSpeed: 1.5,
        animate: false
      };
...
//# sourceMappingURL=map-f38f48c4ca98d11d9d32.bundle.js.map