...
var maplibre_gl = __webpack_require__(593);
...
var PoiItem = __webpack_require__(161);
...
var ActionButtons = __webpack_require__(307);
...
var GeolocationModal = __webpack_require__(309);
...
var server_browser = __webpack_require__(302);
...
var layouts = __webpack_require__(308);
...
var map_poi_MapPoi = /*#__PURE__*/function (_Poi) {
  ...
  function MapPoi(feature) {
    ...
    return _super.call(this, global_id || feature.id, qwant_id, name, poi_poi["POI_TYPE"], ll, className, subClassName);
  }
...
var mapbox_style_configure = __webpack_require__(600);
...
var uri = __webpack_require__(344);
...
var route_utils = __webpack_require__(34);

// EXTERNAL MODULE: ./src/panel/direction/VehicleIcon/index.tsx
var VehicleIcon = __webpack_require__(127);
...
var es = __webpack_require__(602);

// EXTERNAL MODULE: ./src/libs/geojson.js
var geojson = __webpack_require__(249);
...
var color = __webpack_require__(248);
...
var bounds = __webpack_require__(171);

// EXTERNAL MODULE: ./src/mapbox/locale.ts
var locale = __webpack_require__(604);
...
Scene.prototype.isBBoxInExtendedViewport = function (bbox) {
  ...
  viewport.setSouthWest(new maplibre_gl["LngLat"](viewport.getWest() - width, clamp(-85, 85, viewport.getSouth() - height)).wrap()); // Check if the bbox overlaps the viewport
...
//# sourceMappingURL=map-0fc282c28ff64ae588d8.bundle.js.map