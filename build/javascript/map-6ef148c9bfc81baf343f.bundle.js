...
var maplibre_gl = __webpack_require__(646);
...
var ActionButtons = __webpack_require__(329);
...
poi_popup_PoiPopup.prototype.addListener = function (layer) {
  ...
  this.map.on('mouseleave', layer, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
poi_popup_PoiPopup.prototype.createOSMPopup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(layerPoi, event) {
    var poi;
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return idunn_poi_default.a.poiApiLoad({
            ...
            qwant_id: layerPoi.properties.qwant_id
          }, {
            simple: true
          });
        case 2:
...
poi_popup_PoiPopup.prototype.showPopup = function (poi, event) {
  ...
  this.popupHandle = new maplibre_gl["Popup"](popupOptions).setLngLat(poi.latLon).setHTML('<div class="poi_popup__wrapper"/></div>').addTo(this.map);
...
function extended_scale_control_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, extended_scale_control_toPropertyKey(descriptor.key), descriptor); } }
...
function extended_scale_control_toPropertyKey(t) { var i = extended_scale_control_toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
function extended_scale_control_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var ExtendedScaleControl = /*#__PURE__*/function (_ScaleControl) {
  ...
  function ExtendedScaleControl(options, container) {
    ...
    _this = _callSuper(this, ExtendedScaleControl, [options]);
...
function extended_attribution_control_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, extended_attribution_control_toPropertyKey(descriptor.key), descriptor); } }
...
function extended_attribution_control_toPropertyKey(t) { var i = extended_attribution_control_toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
function extended_attribution_control_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function extended_attribution_control_callSuper(t, o, e) { return o = extended_attribution_control_getPrototypeOf(o), extended_attribution_control_possibleConstructorReturn(t, extended_attribution_control_isNativeReflectConstruct() ? Reflect.construct(o, e || [], extended_attribution_control_getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
function extended_attribution_control_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (extended_attribution_control_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function extended_attribution_control_get() { if (typeof Reflect !== "undefined" && Reflect.get) { extended_attribution_control_get = Reflect.get.bind(); } else { extended_attribution_control_get = function _get(target, property, receiver) { var base = extended_attribution_control_superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(arguments.length < 3 ? target : receiver); } return desc.value; }; } return extended_attribution_control_get.apply(this, arguments); }
...
function extended_attribution_control_getPrototypeOf(o) { extended_attribution_control_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return extended_attribution_control_getPrototypeOf(o); }
...
function extended_attribution_control_setPrototypeOf(o, p) { extended_attribution_control_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return extended_attribution_control_setPrototypeOf(o, p); }
...
var ExtendedAttributionControl = /*#__PURE__*/function (_AttributionControl) {
  ...
  function ExtendedAttributionControl(options, container) {
    ...
    _this = extended_attribution_control_callSuper(this, ExtendedAttributionControl, [options]);
    _this.parentContainer = container;
    return _this;
  }
...
}(maplibre_gl["AttributionControl"]);

// EXTERNAL MODULE: ./src/libs/geolocation.js
var geolocation = __webpack_require__(121);

// EXTERNAL MODULE: ./src/modals/GeolocationModal.jsx
var GeolocationModal = __webpack_require__(331);
...
var server_browser = __webpack_require__(322);
...
function extended_geolocate_control_toPropertyKey(t) { var i = extended_geolocate_control_toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
function extended_geolocate_control_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function extended_geolocate_control_callSuper(t, o, e) { return o = extended_geolocate_control_getPrototypeOf(o), extended_geolocate_control_possibleConstructorReturn(t, extended_geolocate_control_isNativeReflectConstruct() ? Reflect.construct(o, e || [], extended_geolocate_control_getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
function extended_geolocate_control_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (extended_geolocate_control_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function extended_geolocate_control_get() { if (typeof Reflect !== "undefined" && Reflect.get) { extended_geolocate_control_get = Reflect.get.bind(); } else { extended_geolocate_control_get = function _get(target, property, receiver) { var base = extended_geolocate_control_superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(arguments.length < 3 ? target : receiver); } return desc.value; }; } return extended_geolocate_control_get.apply(this, arguments); }
...
function extended_geolocate_control_getPrototypeOf(o) { extended_geolocate_control_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return extended_geolocate_control_getPrototypeOf(o); }
...
function extended_geolocate_control_setPrototypeOf(o, p) { extended_geolocate_control_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return extended_geolocate_control_setPrototypeOf(o, p); }
...
var extended_geolocate_control_ExtendedGeolocateControl = /*#__PURE__*/function (_GeolocateControl) {
  ...
  function ExtendedGeolocateControl(options, container) {
    ...
    _this = extended_geolocate_control_callSuper(this, ExtendedGeolocateControl, [options]);
  ...
  extended_geolocate_control_createClass(ExtendedGeolocateControl, [{
    ...
    key: "trigger",
    value: function () {
      var _trigger = extended_geolocate_control_asyncToGenerator( /*#__PURE__*/extended_geolocate_control_regeneratorRuntime().mark(function _callee() {
        var state;
        return extended_geolocate_control_regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
    ...
    value: function _onError(error) {
      ...
      extended_geolocate_control_get(extended_geolocate_control_getPrototypeOf(ExtendedGeolocateControl.prototype), "_onError", this).call(this, error);
...
function extended_nav_control_toPropertyKey(t) { var i = extended_nav_control_toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
function extended_nav_control_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var layouts = __webpack_require__(330);

// EXTERNAL MODULE: ./local_modules/nconf_getter/index.js
var nconf_getter = __webpack_require__(47);

// EXTERNAL MODULE: ./src/adapters/poi/poi.ts
var poi_poi = __webpack_require__(40);
var poi_default = /*#__PURE__*/__webpack_require__.n(poi_poi);

// CONCATENATED MODULE: ./src/adapters/poi/map_poi.js
function map_poi_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, map_poi_toPropertyKey(descriptor.key), descriptor); } }
...
function map_poi_toPropertyKey(t) { var i = map_poi_toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
function map_poi_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
function map_poi_callSuper(t, o, e) { return o = map_poi_getPrototypeOf(o), map_poi_possibleConstructorReturn(t, map_poi_isNativeReflectConstruct() ? Reflect.construct(o, e || [], map_poi_getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
function map_poi_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (map_poi_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function map_poi_getPrototypeOf(o) { map_poi_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return map_poi_getPrototypeOf(o); }
...
function map_poi_setPrototypeOf(o, p) { map_poi_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return map_poi_setPrototypeOf(o, p); }
...
var map_poi_MapPoi = /*#__PURE__*/function (_Poi) {
  ...
  function MapPoi(feature) {
    ...
    var _feature$properties = feature.properties,
      ...
      qwant_id = _feature$properties.qwant_id;
    var ll = maplibre_gl["LngLat"].convert(feature.geometry.coordinates);
    return map_poi_callSuper(this, MapPoi, [global_id || feature.id, qwant_id, name, poi_poi["POI_TYPE"], ll, className, subClassName]);
  }
  return map_poi_createClass(MapPoi);
}(poi_default.a);

// EXTERNAL MODULE: ./local_modules/mapbox_style_configure/index.js
var mapbox_style_configure = __webpack_require__(653);
...
var uri = __webpack_require__(366);
...
var route_utils = __webpack_require__(33);

// EXTERNAL MODULE: ./src/panel/direction/VehicleIcon/index.tsx
var VehicleIcon = __webpack_require__(138);
...
function _defineProperty(obj, key, value) { key = route_styles_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function route_styles_toPropertyKey(t) { var i = route_styles_toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
function route_styles_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var project = ratio => ls => {
  ...
  var lngLat = Object(invariant_dist_es["a" /* getCoord */])(Object(along_dist_es["a" /* default */])(ls, length * ratio));
...
function findDistinctSegments(linestrings) {
  ...
  var featuresCoords = linestrings.map(dist_es["a" /* coordAll */]);
...
function scene_direction_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, scene_direction_toPropertyKey(descriptor.key), descriptor); } }
...
function scene_direction_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function scene_direction_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? scene_direction_ownKeys(Object(t), !0).forEach(function (r) { scene_direction_defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : scene_direction_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function scene_direction_defineProperty(obj, key, value) { key = scene_direction_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function scene_direction_toPropertyKey(t) { var i = scene_direction_toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
function scene_direction_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var scene_direction_createMarker = function createMarker(lngLat) {
  ...
  return new maplibre_gl["Marker"](scene_direction_objectSpread(scene_direction_objectSpread({}, options), {}, {
    element
  })).setLngLat(lngLat);
};
...
var getLabelsBbbox = (labelPositions, routesBbox) => {
  ...
  var labelsBbbox = new maplibre_gl["LngLatBounds"]();
  ...
  scene_direction_createClass(SceneDirection, [{
    ...
    value: function displayRoutes(activeRouteId) {
      if (this.routes && this.routes.length > 0) {
        ...
        var routesBbox = new maplibre_gl["LngLatBounds"]();
        this.routes.forEach(route => {
    ...
    value: function computeBBox(_ref10) {
      ...
      var _bbox = Object(es["a" /* default */])(geometry),
        ...
        maxX = _bbox2[2],
        maxY = _bbox2[3];
      return new maplibre_gl["LngLatBounds"]([minX, minY], [maxX, maxY]);
    }
  }, {
    key: "highlightStep",
...
var libs_pois = __webpack_require__(16);

// EXTERNAL MODULE: ./src/adapters/pois_styles.ts
var pois_styles = __webpack_require__(652);

// EXTERNAL MODULE: ./src/adapters/icon_manager.ts
var icon_manager = __webpack_require__(141);
var icon_manager_default = /*#__PURE__*/__webpack_require__.n(icon_manager);

// EXTERNAL MODULE: ./src/libs/eco-responsible.ts
var eco_responsible = __webpack_require__(100);

// CONCATENATED MODULE: ./src/adapters/scene_category.js
function scene_category_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function scene_category_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? scene_category_ownKeys(Object(t), !0).forEach(function (r) { scene_category_defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : scene_category_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function scene_category_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, scene_category_toPropertyKey(descriptor.key), descriptor); } }
...
function scene_category_defineProperty(obj, key, value) { key = scene_category_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function scene_category_toPropertyKey(t) { var i = scene_category_toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
function scene_category_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var scene_category_SceneCategory = /*#__PURE__*/scene_category_createClass(function SceneCategory(map) {
  ...
  scene_category_defineProperty(this, "initActiveStateMarkers", () => {
    ...
    this.hoveredMarker = new maplibre_gl["Marker"]({
    ...
    this.selectedMarker = new maplibre_gl["Marker"]({
      element: Object(icon_manager["createPinIcon"])({
        className: 'marker--category'
      }),
      anchor: 'bottom'
  ...
  scene_category_defineProperty(this, "selectPoi", _ref => {
    var poi = _ref.poi,
      ...
      pois = _ref.pois;
    var isEcoResponsible = Object(eco_responsible["isEcoResponsibleCategory"])(poiFilters.category);
    ...
    window.app.navigateTo("/place/".concat(Object(libs_pois["toUrl"])(poi)).concat(isEcoResponsible ? "&eco=".concat(poiFilters.category) : ''), {
      poi,
      poiFilters,
      pois,
      centerMap: true
...
// EXTERNAL MODULE: ./src/libs/url_utils.ts
var url_utils = __webpack_require__(25);

// EXTERNAL MODULE: ./src/libs/bounds.ts
var bounds = __webpack_require__(178);

// EXTERNAL MODULE: ./src/mapbox/locale.ts
var locale = __webpack_require__(657);
...
function scene_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function scene_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? scene_ownKeys(Object(t), !0).forEach(function (r) { scene_defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : scene_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function scene_defineProperty(obj, key, value) { key = scene_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function scene_toPropertyKey(t) { var i = scene_toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
function scene_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
Scene.prototype.initMapBox = function (_ref2) {
  ...
  Object(maplibre_gl["setRTLTextPlugin"])("".concat(scene_baseUrl, "statics/build/javascript/map_plugins/mapbox-gl-rtl-text-").concat(compilationHash, ".js"), error => {
    if (error) {
      adapters_error["default"].send('scene', 'setRTLTextPlugin', 'Failed to load mapbox RTL plugin', error);
    }
  }, /* lazy */true);
  this.mb = new maplibre_gl["Map"](scene_objectSpread({
  ...
  window.map = this;
  var interactiveLayers = ['poi-level-0', 'poi-level-1', 'poi-level-2', 'poi-level-3', 'poi-level-public-transports-1', 'poi-level-public-transports-2'];
  this.hoveredPoi = null;
  ...
  this.mb.on('load', () => {
    ...
    var longTouchCancellingEvents = ['touchend',
...
Scene.prototype.isBBoxInExtendedViewport = function (bbox) {
  ...
  var height = viewport.getNorth() - viewport.getSouth();

  // Compute extended viewport, with lats between -85 and 85
  viewport.setNorthEast(new maplibre_gl["LngLat"](viewport.getEast() + width, clamp(-85, 85, viewport.getNorth() + height)).wrap());
  viewport.setSouthWest(new maplibre_gl["LngLat"](viewport.getWest() - width, clamp(-85, 85, viewport.getSouth() - height)).wrap());
...
Scene.prototype.fitBbox = function (bbox, forceAnimate) {
  ...
  if (bbox instanceof Array) {
    bbox = new maplibre_gl["LngLatBounds"](bbox);
  }
...
Scene.prototype.fitMap = function (item, forceAnimate) {
  // BBox
  if (item instanceof maplibre_gl["LngLatBounds"] || Array.isArray(item)) {
...
Scene.prototype.addMarker = function (poi) {
  ...
  var marker = new maplibre_gl["Marker"]({
    element,
    anchor: 'bottom',
    offset: [0, -5]
...
Scene.prototype.cleanMarker = /*#__PURE__*/scene_asyncToGenerator( /*#__PURE__*/scene_regeneratorRuntime().mark(function _callee() {
...
Scene.prototype.isWindowedPoi = function (poi) {
  return this.mb.getBounds().contains(new maplibre_gl["LngLat"](poi.latLon.lng, poi.latLon.lat));
};
...
Scene.prototype.moveMobileBottomUI = function () {
  ...
  var uiControls = ['.map_control__scale_attribute_container', '.maplibregl-ctrl-geolocate', '.direction_shortcut'];
...
//# sourceMappingURL=map-6ef148c9bfc81baf343f.bundle.js.map