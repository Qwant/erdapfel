...
function Scene() {
  ...
  this.mb.on('load', () => {
    ...
    this.mb.on('click', 'poi-level-3', (e) => {
      let poi = new Poi({lat : e.features[0].geometry.coordinates[1], lng : e.features[0].geometry.coordinates[0]}, e.features[0].properties.class, e.features[0].properties.subclass)
